...
enum COMMAND
	{
		...
		MGETWILD,
		MPUTWILD,
		DIR_,		// _ per evitare conflitti con la directory pointer DIR
		LDIR,
		LS,
		LLS,
		MKDIR,
		...
		LPWD,
		EXIT
	};			// ogni cambiamento qui dovrà essere fatto \
				anche accordingly nella commandlist  \
				 file client_ftp_fucntions.c
